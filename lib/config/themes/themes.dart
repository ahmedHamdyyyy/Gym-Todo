...
import 'package:gym/config/colors/colors.dart';
...
class Themes {
  ThemeData theme(int t) => t == 0
      ? ThemeData.light(
          ...
          cardTheme: CardTheme(
            color: backGroundColor[t],
          ),
          textTheme: TextTheme(
            titleMedium: TextStyle(
              color: kTextColor[t],
            ),
            bodyLarge: TextStyle(color: kTextColor[t],),
            bodyMedium: TextStyle(color: kTextColor[t],),
            labelMedium: TextStyle(color: kTextColor[t],),
          ),
          ...
          elevatedButtonTheme: ElevatedButtonThemeData(
            style: ElevatedButton.styleFrom(
              elevation: 0,
              backgroundColor: primaryColor2[t],
      ...
      : ThemeData.dark(useMaterial3: true).copyWith(
          appBarTheme: _appBar(t),
          cardTheme: CardTheme(color: backGroundColor[t]),
          iconTheme: IconThemeData(color: kGroundColorIcon[t]),
          textTheme: TextTheme(
            displayMedium: TextStyle(
            color: kTextColor[t],),bodyLarge:
          TextStyle(color: kTextColor[t],),
            bodyMedium: TextStyle(color: kTextColor[t],),
            labelMedium: TextStyle(color: kTextColor[t],),),
          inputDecorationTheme: InputDecorationTheme(
            floatingLabelBehavior: FloatingLabelBehavior.always,
